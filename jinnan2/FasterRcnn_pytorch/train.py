...
def eval(dataloader, faster_rcnn, test_num=981):
    ...
    for iou_thresh in [0.5,0.55,0.6,0.65,0.7,0.75,0.8,0.85,0.9,0.95]:
        result = eval_detection_voc(
            ...
            use_07_metric=False,iou_thresh=iou_thresh)
    ...
    for epoch in range(opt.epoch):
        ...
        for ii, (img, bbox_, label_, scale) in (enumerate(dataloader)):
            ...
            if (ii) % opt.plot_every == 0:
                ...
                best_path = trainer.save(save_path =opt.load_path)
        ...
        # best_path = trainer.save(save_path='../checkpoints/model.pth')
